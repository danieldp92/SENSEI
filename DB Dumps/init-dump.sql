...
) ENGINE=InnoDB AUTO_INCREMENT=53072 DEFAULT CHARSET=utf8mb4;
...
CREATE TABLE `product` (
  ...
  `ships_from` varchar(2000) DEFAULT NULL,
  `ships_to` varchar(2000) DEFAULT NULL,
  `price` varchar(50) NOT NULL,
  `price_eur` varchar(50) DEFAULT NULL,
...
CREATE TABLE `sonarqube` (
  ...
  `label_three` varchar(50) DEFAULT NULL,
...
CREATE TABLE `vendor` (
  ...
  `score_normalized` varchar(200) DEFAULT NULL,
  `registration` varchar(200) DEFAULT NULL,
  `registration_deviation` varchar(200) DEFAULT NULL,
  `last_login` varchar(200) DEFAULT NULL,
  `last_login_deviation` varchar(200) DEFAULT NULL,
  `sales` varchar(200) DEFAULT NULL,
  `info` longtext,
  `feedback` int(11) DEFAULT NULL,
  `pgp` varchar(5000) DEFAULT NULL,
...
-- Dump completed on 2021-07-29 22:36:10
